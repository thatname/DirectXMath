...
inline Matrix Matrix::CreatePerspectiveFieldOfView(float fov, float aspectRatio, float nearPlane, float farPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixPerspectiveFov(fov, aspectRatio, nearPlane, farPlane));
    return R;
}
...
inline Matrix Matrix::CreatePerspective(float width, float height, float nearPlane, float farPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixPerspective(width, height, nearPlane, farPlane));
    return R;
}
...
inline Matrix Matrix::CreatePerspectiveOffCenter(float left, float right, float bottom, float top, float nearPlane, float farPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixPerspectiveOffCenter(left, right, bottom, top, nearPlane, farPlane));
    return R;
}
...
inline Matrix Matrix::CreateOrthographic(float width, float height, float zNearPlane, float zFarPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixOrthographic(width, height, zNearPlane, zFarPlane));
    return R;
}
...
inline Matrix Matrix::CreateOrthographicOffCenter(float left, float right, float bottom, float top, float zNearPlane, float zFarPlane) noexcept
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixOrthographicOffCenter(left, right, bottom, top, zNearPlane, zFarPlane));
    return R;
}
...
inline Matrix Matrix::CreateLookAt(const Vector3& eye, const Vector3& target, const Vector3& up) noexcept
{
    ...
    XMStoreFloat4x4(&R, XMMatrixLookAt(eyev, targetv, upv));
    return R;
}
...
inline Matrix Matrix::CreateFromRollPitchYaw(float roll, float pitch, float yaw) noexcept
{
    using namespace DirectX;
    Matrix R;
    XMStoreFloat4x4(&R, XMMatrixRotationRollPitchYaw(roll, pitch, yaw));
    return R;
}
...
inline Quaternion Quaternion::CreateFromRollPitchYaw(float roll, float pitch, float yaw) noexcept
{
    using namespace DirectX;
    Quaternion R;
    XMStoreFloat4(&R, XMQuaternionRotationRollPitchYaw(roll, pitch, yaw));
    return R;
}
