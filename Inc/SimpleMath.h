...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        struct Matrix : public XMFLOAT4X4
        {
            ...
            static Matrix CreateFromRollPitchYaw(float roll, float pitch, float yaw) noexcept;
        ...
        struct Quaternion : public XMFLOAT4
        {
            ...
            static Quaternion CreateFromRollPitchYaw(float roll, float pitch, float yaw) noexcept;
